...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    description: 'Crawl all pages, test all interactions, validate all APIs, autofix safe issues, and ship with confidence. Computer use adds real-browser visual verification for dark mode and responsive layouts.',
    category: 'quality',
    phase: 'quality',
    icon: 'TestTubes',
    highlights: ['Full site crawl', '13 execution phases', 'Autofix 23 patterns', 'Visual verification'],
