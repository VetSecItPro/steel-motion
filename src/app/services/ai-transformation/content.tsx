...
const features = [
  {
    ...
    description:
      "We build systems that handle repetitive tasks automatically and accurately. Typical engagement: automated invoice routing that reduced a 4-person manual process to zero touch.",
  },
  {
    icon: FileText,
    title: "Document Processing",
    description:
      "Invoices, forms, contracts. We set up AI to read, extract, and organize your documents without human intervention. Typical engagement: extracting line items from 500+ supplier invoices per month into an ERP with 99%+ accuracy.",
  },
  {
    icon: BarChart3,
    title: "Predictive Analytics",
    description:
      "We build dashboards and alert systems that surface patterns before they become problems. Typical engagement: demand forecasting that reduced inventory carrying costs by 18%.",
  },
  {
    icon: Brain,
    title: "Custom AI Models",
    description:
      "Off-the-shelf AI doesn't always fit. We build models trained on your data for your specific problems. Typical engagement: a classification model trained on 50K support tickets to auto-route and prioritize incoming requests.",
  },
  {
    icon: Cog,
    title: "Process Automation (RPA)",
    description:
      "Software bots that work across your existing systems. No ripping and replacing, automation layered on top. Typical engagement: syncing data between a legacy CRM and accounting system every 15 minutes, eliminating daily manual exports.",
  },
  {
    icon: Plug,
    title: "AI Integration",
    description:
      "We plug AI into what you're using now without breaking anything. Typical engagement: adding LLM-powered summarization to an existing support dashboard with zero downtime.",
  },
]
            ...
            {phases.map((phase, i) => (
              ...
              >
                ...
                >
                  ...
                  <div className="bg-sm-surface-secondary rounded-lg px-4 py-3">
