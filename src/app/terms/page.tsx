      ...
      <section className="bg-gradient-to-br from-[#0a1728] via-[#0f2640] to-[#1a3a5c] text-white py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Agreement to Terms</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Services Description</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Intellectual Property</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">User Responsibilities</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Confidentiality</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Limitation of Liability</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Disclaimer of Warranties</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Indemnification</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Third-Party Links</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Governing Law</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Changes to Terms</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Severability</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00F2FF] mb-4">Contact Information</h2>
              <p className="text-[#B3B3B3] leading-relaxed">
